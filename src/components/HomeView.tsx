          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-2.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-[11px] font-black flex items-center gap-1 shadow-2xs cursor-pointer active:scale-95 transition-all"
                title="إضافة وتعديل جدول الحصص بسهولة وسرعة"
              >
                ...
                <div className="bg-white p-4 rounded-2xl border border-slate-200/90 text-center space-y-2.5">
                  ...
                  <div className="flex items-center justify-center gap-2 pt-1">
                    <button
                      type="button"
                      onClick={() => setIsScheduleManagerOpen(true)}
                      className="px-3.5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-black rounded-xl shadow-xs flex items-center gap-1.5 cursor-pointer active:scale-95"
                    >
                      <Calendar className="w-3.5 h-3.5" />
                      <span>إضافة حصص للجدول 📅</span>
                    </button>
                    <button
                      type="button"
                      onClick={() => setIsImportTimetableModalOpen(true)}
                      className="px-3 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-xs font-black rounded-xl border border-emerald-300 flex items-center gap-1.5 cursor-pointer"
                    >
                      <Sparkles className="w-3.5 h-3.5 text-emerald-600" />
                      <span>استيراد من صورة 📸</span>
                    </button>
                  </div>
                </div>
              )}
